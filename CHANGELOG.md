...
## [0.4.0](https://github.com/spacesprotocol/spaces/compare/spaces_client-v0.3.1...spaces_client-v0.4.0) - 2026-09-14

### Bug Fixes

- *(client)* Recover wallets from spaces genesis, not chain tip

### Features

- *(client)* Log database migration on legacy data dir
